# Unit testing for the sentence evaluator
...
class TestMedium(unittest.TestCase):
    def test_medium(self):
        # Represents the sentence "Everyone likes rugby and football and
        # dislikes golf"
        ...
        # Represents four people, all of whom like rugby and football and
        # dislike golf
        scenario1 = [
            {
        ...
        # Represents the sentence "There exists someone who, if they like
        # tennis, they dislike football"
        ...
        # Should be true, since there are people for whom both predicates are
        # false
...
class TestHard(unittest.TestCase):
    def test_hard(self):
        # Represents the sentence "Everyone owns a large pet"
        # i.e. ∀x ∃y owns(x, y) ∧ large(y)
        sentence1 = {
            "quantifiers": ["∀", "x", "∃", "y"],
            "predicates": {
                "P": ["owns", "x", "y"],
        ...
        # Should be false as person 2 does not own a large pet
        self.assertEqual(evaluate_sentence(sentence1, scenario1), False)
        ...
        # Represents the sentence "Anyone who owns a pet owns a small cat"
        # i.e. ∀x ∃y owns(x, y) → (small(y) ∧ cat(y))
        sentence2 = {
            "quantifiers": ["∀", "x", "∃", "y"],
            "predicates": {
                "P": ["owns", "x", "y"],
        ...
        # Should be false, since person 2 owns a pet, but it is a small
        # goldfish
        self.assertEqual(evaluate_sentence(sentence2, scenario2), False)
